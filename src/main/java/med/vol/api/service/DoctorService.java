...
public class DoctorService {
    ...
    public DoctorResponseDTO findById(Long id) {
        Doctor doctor = doctorRepository.findById(id).orElseThrow(() -> new ResourceNotFundException("Doctor not found!"));
        if (!doctor.getStatus()) {
            throw new ResourceNotFundException("Doctor is inactive!");
        }
